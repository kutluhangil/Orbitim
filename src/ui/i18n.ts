...
const EN = {
  ...
  openNaturalEvents: 'Open natural events',
  catalogued: 'Catalogued',
  refreshNaturalEvents: 'Refresh open natural events',
  loadingNaturalEvents: 'Loading EONET event catalogue…',
  naturalEventsUnavailable: 'NASA EONET event catalogue unavailable: {error}',
  naturalEventsScopeNote: 'Open-event catalogue. Latest listed geometry is not satellite imagery or a verified incident boundary.',
  openEventsShown: 'Showing {shown} newest of {total} returned open events',
  openNaturalEventSource: 'Open source for {event}',
  openEonetDocumentation: 'Open NASA EONET documentation ↗',
  ...
  ,missionMilestone: 'Mission milestone'
  ,missionSource: 'NASA mission source'
  ,openMissionSource: 'Open NASA mission source'
  ,closeMissionDossier: 'Close mission dossier'
  ,spacecraftPositionNote: 'The scene position follows JPL Horizons at the live instant; scrubbing time uses the documented reference path.'
  ,atlas: 'Atlas'
...
const TR: Record<TranslationKey, string> = {
  ...
  openNaturalEvents: 'Açık doğal olaylar',
  catalogued: 'Katalog',
  refreshNaturalEvents: 'Açık doğal olayları yenile',
  loadingNaturalEvents: 'EONET olay kataloğu yükleniyor…',
  naturalEventsUnavailable: 'NASA EONET olay kataloğu kullanılamıyor: {error}',
  naturalEventsScopeNote: 'Açık olay kataloğu. Son listelenen geometri, uydu görüntüsü veya doğrulanmış olay sınırı değildir.',
  openEventsShown: 'Dönen {total} açık olayın en yeni {shown} kaydı gösteriliyor',
  openNaturalEventSource: '{event} için kaynağı aç',
  openEonetDocumentation: 'NASA EONET dokümantasyonunu aç ↗',
  ...
  ,missionDossier: 'görev dosyası'
  ,launchDate: 'Fırlatma tarihi'
  ,missionPurpose: 'Görev amacı'
  ,missionMilestone: 'Görev dönüm noktası'
  ,missionSource: 'NASA görev kaynağı'
  ,openMissionSource: 'NASA görev kaynağını aç'
  ,closeMissionDossier: 'Görev dosyasını kapat'
  ,spacecraftPositionNote: 'Sahnedeki konum canlı anda JPL Horizons verisini izler; zaman kaydırıldığında belgelenmiş referans rota kullanılır.'
  ,atlas: 'Atlas'
